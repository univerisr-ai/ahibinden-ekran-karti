...
# AYARLAR
# ==========================================
CURL_FILE = Path(os.getcwd()) / "curl_request.sh"
OUTPUT_FILE = Path(os.getcwd()) / "ilanlar.json"
...
PAGE_WORKERS = 3
PAGE_SIZE = 50             # Sayfa başına ilan
MAX_PAGES_PER_SEGMENT = 20 # Segment başına max sayfa (50*20=1000 ilan)
REQUEST_DELAY = 0.6        # İstekler arası bekleme (sn)
REQUEST_TIMEOUT = 25       # İstek zaman aşımı (sn)
MAX_RETRIES = 3
